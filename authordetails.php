...
<div class="container my-custom-container"> 
 ...
 <div class="homephp"><br><br><br>
<h3><font color='#8B008B'>Edit Your Profile</font></h3>
<br>
     <div class="form">
     ...
     <?php
      $un = $_SESSION['user'];
      //echo $un;
      $result1 = mysqli_query($con,"select * from author where username = '$un'");
      $test1 = mysqli_fetch_array($result1);
      if (!$result1) 
        {
          echo "Error: Data not found..";
        }
      $auname=$test1['username'];

      $result2 = mysqli_query($con,"select * from login where username = '$un' and privilege=0 and confirmation=1");
    ...
    ?>
  <br>
  <b>Username : &nbsp;</b>   <input type="text" name="currentun" value="<?PHP echo     $auname?>" disabled/> <br/> <br/>
  <b>Change password : &nbsp;</b>  <input type="password" name="newpswd" value="<?PHP echo   $apwd?>"><br/> <br/>
  ...
  <?php 
      if(isset($_POST['change'])){
        ...
        if($newpass)
        {
      $res = mysqli_query($con,"update login set password='$newpass' where username='$un' and privilege=0");
