...
<br>
     ...
     <?php
      $un = $_SESSION['user'];
      //echo $un;
      $result1 = mysqli_query($con,"select * from editor where username = '$un'");
      $test1 = mysqli_fetch_array($result1);
      if (!$result1) 
        {
          echo "Error: Data not found..";
        }
      $euname=$test1['username'];

      $result2 = mysqli_query($con,"select * from login where username = '$un' and privilege=1");
  ...
  <b>Username : &nbsp;</b>    <input type="text" name="currentun" value="<?PHP echo     $euname?>" disabled/> <br/> <br/>
   <b>Change password : &nbsp;</b>      <input type="password" name="newpswd" value="<?PHP echo     $epwd?>" ><br/> <br/> <br/>
  ...
  <?php 
      if(isset($_POST['change'])){
        ...
        if($newpass)
        {
      $res = mysqli_query($con,"update login set password='$newpass' where username='$un' and privilege=1");
